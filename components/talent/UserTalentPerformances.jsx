...
export default function UserTalentPerformances({userTalent, user }) {
    const[ userParticipation , setUserParticipation ] = useState(userTalent.contestants.find(c => c.user_id === user._id))
  ...
  return (
    ...
    // className=" b g-white flex-col justify-center p- 1 items-center rounded-xl ">
        ...
        onPress={
                ...
                () => {
                    userTalent.status == "closed" ?router.navigate({ pathname: '/DisplayEdition',params: { 
                        talentRoom_id : userTalent._id,
                        edition_id : userTalent.edition_id ,
        ...
        className="bg-[#000000] w-[32.7%] min-h -[32.7%] flex-col mb-1 justify-start items-center rounded-md">
             <View
                      ...
                      className="w-[50%] h-[100%] gap- 1 flex-col justify-between items-center">
                            ...
                            className="text-center text-sm font-black text-yellow-400">
                                {userTalent.status}
                                  ...
                                  <Text
                                     style={{fontSize:8}}
                                     className="text-center text-sm mt-auto font-black text-white">
                                      {rank < 4 ? "TOP ":"TOP"}
                                  </Text>
                                  <Text
                                     style={{fontSize:9}}
              ...
              className=" w-[100%] h-[60%] b g-white flex-col p-1 justify-start items-center rounded-xl ">
                      ...
                      className="w-[100%] h-[20%] flex-row text-center justify-between items-center ">  
                        {/* {userPost.status == "stage" &&  (
                           ...
                           <View
                           className="flex-1 flex-row w-[100%] h-[100%] justify-evenly items-center">
                                  <Text
                                     style={{fontSize:9}}
                      ...
                      <View
                        className="w-[100%] h-[80%] p-1 justify-center items-center rounded-sm">
                           <Image
