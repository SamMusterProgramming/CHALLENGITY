...
import FormField from '../../custom/FormField.jsx'
import {  router } from 'expo-router'

import { authLogin, getFavouriteChallenges, getFollowData, getFollowings, getNotificationByUser,
   getTopChallenges,
   getUserFriendsData,  getUserPrivateChallenges, getUserPrivateParticipateChallenges, getUserPublicChallenges, getUserPublicParticipateChallenges, getUserQueueTalent, getUserTalent, getUserTalentPerformances, isAuthenticated } from '../../../apiCalls.js'
import {  useGlobalContext } from '../../../context/GlobalProvider.js'

// import AuthContent from '../../context/AuthContent'
// import { screenSize } from '../../helper.js'
import LoadingPage from '../../custom/LoadingPage.jsx'
 ...
 //******************************* authentification here *******************************************************/
  ...
  return (
         ...
         className="w-[100%]  h-[100%]  justify-between absolut e top- 0 gap- flex-col items-center bg-primary   ">
              ...
              <View className=" w-[70%] h-[30%] mt- auto rounded-xl border-b-2 border-[#de4108]  justify-between items-center p-6 b b g-white">
              ...
              <View className="w-[100%] rounded-b-[50px] justify-start 80 mt -auto gap-4 flex-col py-2 border-l-2 border-r-2 border-b-2 border-[#de4108] items-center">  
