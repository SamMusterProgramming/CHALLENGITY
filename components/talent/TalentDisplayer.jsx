...
export default function TalentDisplayer({userTalent, user }) {
  ...
  return (
   <>
    ...
    <>
    <View  
        // style={{height:h * 0.114 * 3 + 25}}
        className=" bg- [#4f1c1c]  black [#353232] [#676c73] w-[100%] mt- 1 h-[27%] round ed-t-lg flex-col  justify-start items-start rounded-md ">
            ...
            className="b g-[#ecf2fc] w-[100%] flex- 1  h-[70%] rounded-b-xl  flex-row justify-between  items-start ">
                 ...
                 <View
                    className = "w-[74%]  h-[100%] bg- [#29374e] primary  [#010101]  flex-col py- 2 justify-start items-center  ">
                        ...
                        <View
                            className = " bg- [#29374e]  [#edebeb] rounded-lg h- [30%]  w- [100%] mb-1  flex -1 rounde d-t-xl flex-row  gap-2 justify-center py-1  items-end px-1">
        ...
        <View
        // style={{height: h - h * 0.114 * 3 - 25 }}
        className=" bg- [#e4dfdf] primary  [#303030] w-[62%]  py- 2 h-[63%] rounded-b-xl flex-col justify-between items-center  ">
            ...
            {selectedContestant ? (
                <>
                  <View
                                className=" flex- 1 w-[100%]  px-2 mb- 2 flex-row h- [10%] pb-2 pt-6 justify-between gap-8 items-center"> 
                  ...
                  <View 
                                    ...
                                    >
                                        ...
                                        <TouchableOpacity
                                                ...
                                                className=" w-[100%] h-[100%]    flex-row justify-center items-center   ">
                                                
                                                            <Image
                                                                className="w-[100%] h-[100%]  rounded-md"
                                                                source={{uri: selectedContestant && selectedContestant.thumbnail?.publicUrl || "https://firebasestorage.googleapis.com/v0/b/challengify-wgt.firebasestorage.app/o/avatar%2F67.jpg?alt=media&token=d32c765c-31bc-4f74-8925-de45b2640544"}}
                  ...
                  <TouchableOpacity
                                                ...
                                                className="absolute top-0 flex-col bg-primary  black [#303030] [#676c73] rounded-full justify-center p-2 items-start gap-2 ">
                                                    <Image
                                                    source={{uri:selectedContestant && selectedContestant.profile_img}}
                                                    className ="w-[55px] h-[55px] m- rounded-full"
                                                    esizeMethod='cover'
                                                    />  
                                                
                   </TouchableOpacity>
                   <View
                   className = "absolute w-[20%] top-5 left-[17%] flex-row justify-end items-center b g-white">
                         <Text   
                         style ={{fontSize:10}}
                         className="font-black text-white ">
                                  {name && name.part1}  
                   ...
                   <View
                   className = "absolute w-[20%] top-5 right-[17%] flex-row justify-start items-center b g-white">
                        <Text   
                            style ={{fontSize:10}}
                            className="font-black text-white">
                                 {name && name.part2}  
        ...
        <View
                            className = "bg- [#29374e] primary  black w-[100%] h- [50%] mt-1 flex-col justify-start py-4 gap-2 items-center">
                                            <View
                                                className=" flex-col justify-center items-center">
                                                        <Text
                                                        style={{fontSize:9}}
                                            ...
                                            <View
                                            className="  w-[80%]    g-white  px-8 flex-col text-center rounde d-xl justify-center  items-center "> 
                                                <SwingingTitle text={roundTitle} color={"orange"} fontSize={10} />
                                            </View>

                                            <View
                                            className = "absolute top-2 left-0 flex-col justify-start items-center gap- 1" >
                                                       <Image
                                            ...
                                            <View
                                            className = "absolute  top-2 right-0 flex-col justify-start items-center gap- 1" >
                                                        <Image
                                                            style ={{width:width/11 ,height:width/11}}
