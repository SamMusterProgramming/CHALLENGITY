...
const generateNewMatches = (challenge,notifications) => 
    ...
    const renderItem = ({ item ,index }) => (
      ...
      return (
        ...
        <View
          className=" flex-1  py- 1 px- 1 min-w-[100vw] h-  [69%] bg-black [#898888] pb- flex-col justify-start items-center" >
     
              <FlatList
                data={displayData.length > 0 && displayData}
                keyExtractor={(item) => item._id}
                renderItem={({item ,index}) => {
                  return <UserChallengeEntry key={index} challenge={item} user={user}  />
                 }}
