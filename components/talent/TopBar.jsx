...
//   const sidebarWidth = width * 0.8; 
  ...
  return (
    <Animated.View 
    className="w-full h-[5%] absolute top-0 flex-row justify-start items-center borde-t-2 borde-b-2 borde-white g-[#2e2323]"
    style={[
        {
            top:top && top,
    ...
    { transform: [{ translateY: sidebarAnimation }] }]}>
                       <View
                        ...
                        <View
                         className = "w-[37%] h-[100%] ml-auto  flex-row justify-between px- rounde-t-lg g-[#022f2f] g-black items-end ">
                        ...
                        <View
                         className = "w-[13%] ml-auto h-[100%] flex-row justify-end rounde-t-lg px- py-  g-[#0ddddd] g-black items-center ">
                               <TouchableOpacity
                                    onPress={() => router.back()}
