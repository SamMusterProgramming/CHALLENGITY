...
export default function CentralQueuePlayer({selectedContestant ,data, w,h , top ,user,  setSelectedContestant , selectedPostIndex,isScrolling,
    setIsScrolling , setParticipantTrackerId ,talentRoom, participantTrackerId, setParticipationType}) {
      ...
      return (
        ...
        className="absolute  justify-center  items-center rounded-3xl "
        > 
                         <View
