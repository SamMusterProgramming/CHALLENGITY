...
export default function challengeManagement() {
    ...
    const [displayData , setDisplayData] = useState(userPublicChallenges.slice(0,4))
    const [isLoaded ,setIsLoaded] = useState(false)
    const [moreLeft,setMoreLeft] = useState(false)
    const [moreRight,setMoreRight] = useState(userPublicChallenges.length > 4 ? true:false)
...
const handlePublic = ()=> {
        ...
        setIndexList(1)
        setBoxDisplayChallenges(userPublicChallenges)
        setDisplayData(userPublicChallenges.slice(0,4))
        setMoreRight(userPublicChallenges.length > 4 ? true:false)
        setMoreLeft(false)
 }
 
 const handlePrivate = ()=> {
    setIndexList(1)
    const challenges = userPrivateChallenges.filter(challenge => challenge.audience !== "Strict")
...
const handleStrict = ()=> {
  const challenges = userPrivateChallenges.filter(challenge => challenge.audience === "Strict")
  // const challenges2 = privateParticipateChallenges.filter(challenge => challenge.audience === "Strict")
...
useEffect(() => {
  ...
  return (
    ...
    <SafeAreaView className="bg-primary flex-1 min-w-full min-h-full">
       <View
         className="min-w-full  flex-col justify-center px-0 py-1 items-center bg- h-[100%]" >
            ...
            //   style={{height:width/9}}
              className="w-[100vw] flex-row justify-between px-3 items-center rounded-tr-3xl rounded-tl-3xl  mb- bg-[#ecf1f2] h-[6%]" >
                ...
                <View
                 className="w-[50%] h-[90%] rounded-md bg-whit flex-row justify-evenly border-md items-center b-[#1539af]">
                      <TouchableOpacity
                        ...
                        className=" w-[33%] h-[100%] rounded-md  flex-col justify-center items-center gap-">
                             <Image
                                source={icons.publi}
                                resizeMethod='contain'
                      ...
                      <TouchableOpacity
                        ...
                        className="w-[33%] h-[100%] rounded-md bg-whit flex-col justify-center items-center gap-">
                             <Image
                              source={icons.priv}
                              resizeMethod='fill'
                              style={{height:width/22 , width:width/22}}
                        ...
                        className="w-[33%] h-[100%] rounded-md  flex-col justify-center items-center gap-">
                             <Image
                              ...
                              <Text 
                                ...
                                className="font-black text-sm text-blac">
                                     Strict 
                              </Text>   
                      </TouchableOpacity>
             ...
             className="min-w-[100vw] px- border-l-2  border-r-2 flex-col justify-center items-center  ">
                    ...
                    {!selectedChallenge ?(
                             ...
                             className="flex-row flex-wrap justify-between items-center px-2 py-2 gap-y-2 min-w-[100%] h-[330px] bg-[#333338]  ">
                ...
                <View 
                        ...
                        className= " w-[100%] h-[6%] flex-row px-4 justify-between rounded-bl-3xl rounded-br-3xl items-center bg-[#cff1f6] ">
