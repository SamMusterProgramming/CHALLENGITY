...
export default function CommentButton({setIsModalVisible,width , height,
                                    talentRoom , user ,
                                   postData , 
                                   onPress
                                }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        /> */}
        <Ionicons  name = "chatbubble" size={width/18} color={postData.comments.find(c => c.commenter_id == user._id) 
                    ?"orange":"white" } />
        <Text
