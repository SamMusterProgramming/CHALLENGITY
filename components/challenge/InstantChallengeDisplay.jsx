...
import ButtonChallengeAction from './ButtonChallengeAction';
import ChallengeAction from '../modal/ChallengeAction';
import { useGlobalContext } from '../../context/GlobalProvider';
import { addChallengeToFavourite, deleteChallenge, getUserPrivateChallenges, getUserPrivateParticipateChallenges, getUserPublicChallenges, getUserPublicParticipateChallenges, quitChallenge, removeChallengeFromFavourite } from '../../apiCalls';
...
export default function InstantChallengeDisplay({challenge , setSelectedChallenge}) {
    ...
    const [moreRight,setMoreRight] = useState(challenge.participants.length > 4 ? true:false)
    ...
    const handleNext = ()=> {
        const newData = data.posts.slice( indexList * 4 , (indexList + 1)* 4);
        setDisplayData([ ...newData]);
        setIndexList(prev => prev + 1 )
     }

     const handleBack = ()=> {
        const newData = data.posts.slice((indexList - 2) * 4 , (indexList - 1 ) * 4);
         setDisplayData([...newData]);
        setIndexList(prev => prev - 1 )
     }
    ...
    useEffect(() => {
       if(data){
        ...
        (data.posts.length < (indexList) * 4)? setMoreRight(false) :setMoreRight(true)
       }
      }, [indexList])
   ...
   {data && (
        ...
        className = "w-[100%] h-[101%] flex-col  justify-start items-center px-1 rounded-xl g-white">
             ...
             className = "min-w-[100%] h-[7%] gap- rounded-tl-xl rounded-tr-xl flex-row justify-start items-center px- bg-[#2f2c2c]">
                 ...
                 <View
                 className = "w-[55%] h-[100%] flex-row justify-between items-center px-2 g-[#de8124]">
                      <TouchableOpacity
                            onPress={
                      ...
                      <TouchableOpacity 
                            ...
                            className = "px-2 py-1 flex-row justify-center gap-2 items-center">
                                <Image 
                      ...
                      <TouchableOpacity 
                        ...
                        className = "px- py- w-[25%] h-[100%] flex-row  justify-center gap- items-center"> 
            ...
            <View
            className = "w-[100%] h-[93%] flex-col  justify-start items-center px- g-white">
                <View 
                className = "w-[100%] h-[46%] flex-row justify-start rounded- items-center  bg-[#2f2c2c]">
                        <View
                         className = "w-[12%] h-[100%] flex-col justify-start items-center px- py-4 g-white">
                            <View
                                className = "w-[98%] h-[100%] flex-col rounde-tl-xl rounde-tr-xl  justify-between items-center py-2 px- ">
                                    ...
                                    <ScrollView className = "w-[90%] h-[82%] py-1 flex-col justi-enter gap- border-2 border-[#20493e] rounded-lg bg-[#050505] ite-center">
                        ...
                        <View
                        className = "w-[38%] h-[100%] rounded--xl border-r-2 border-b-2 borde-black  flex-col justify-start items-center py-1 px- bg-[#020202]">
                            {displayData.length > 0 && (
                            <InstantPlayer 
                            participant = {displayData[0]} 
                            isVisible={true}
                            challenge ={challenge}
                            rank ={1 + (indexList -1) * 4}
                                />
                            )}
                        ...
                        <View
                        className = "w-[38%] h-[100%] rounded--xl border-b-2 border-black flex-col justify-center items-center py-1 px- bg-[#080808]">
                            {displayData.length > 1 ? (
                            <InstantPlayer 
                            participant = { displayData[1]} 
                            isVisible={true}
                            challenge ={challenge}
                            rank ={2 + (indexList -1) * 4}
                                />
                            ): 
                            (
                            <View
                             className=" w-[94%]  h-[100%] flex-col justify-center rounded-xl   mr-[3%] mt-[3%] bg-[#0f43dd] items-center">  
                                    <Text 
                                      style ={{fontSize:9}}
                        ...
                        <View
                        className = "min-w-[12%] h-[100%] flex-col justify-end items-center py-4 px- bg-[#2f2c2c]">
                            <View
                                className = "w-[98%] h-[100%] flex-col rounde-tl-xl rounde-tr-xl  justify-between items-center py-2 px- ">
                                    <TouchableOpacity 
                                    ...
                                    <ScrollView className = "w-[90%] max-h-[82%] flex-col  border-2 border-[#20493e] rounded-lg justif-center gap- bg-[#020202] ite-center">
                ...
                <View 
                className = "min-w-[100%] h-[46%] flex-row justify-start rounded-bl-xl rounded-br-xl items-center px- bg-[#2f2c2c]">
                       ...
                       <View
                        ...
                        <View 
                        className = "w-[38%] h-[100%] rounded--xl g-[#0a98eb] border-r-2 border-black flex-col justify-center items-center py-1 px- bg-[#020202]">
                            {displayData.length > 2 ? (
                            <InstantPlayer 
                            participant = { displayData[2]} 
                            isVisible={true}
                            challenge ={challenge}
                            rank ={ 3 + (indexList -1) * 4}
                                />
                            ): 
                            (
                            <View
                        ...
                        <View
                        className = "w-[38%] h-[100%] rounded--xl g-[#0a98eb] flex-col justify-center items-center py-1 px- bg-[#080809]">
                            {displayData.length > 3 ? (
                            <InstantPlayer 
                            participant = { displayData[3]} 
                            isVisible={true}
                            challenge ={challenge}
                            rank ={4 + (indexList -1) * 4}
                        ...
                        <View
                        className = "min-w-[12%] h-[100%] flex-col justify-evenly items-center py- px- g-white">
                            <View
                                className = "w-[98%] h-[100%] flex-col px- rounde-tl-xl rounde-tr-xl  justify-between items-center py-1 px- ">
                                    <TouchableOpacity 
                ...
                <View 
                className = "min-w-[100%] h-[7%] rounde-br-xl rounde-bl-xl px-1 flex-row justify-start  items-center py- g-white">
                        <View
                        className = "w-[100%] h-[100%] flex-row rounde-xl rounde-br-xl border-none justify-between items-center py- px- g-[#121313]">
                                        ...
                                        <View
                                        className = "w-[78%] h-[100%] px- py- flex-row rounde-bl-xl rounde-br-xl justify-center items-center px- g-[#ddf1f1]">
                                                <View className = "w-[90%] h-[85%]  flex-row justify-center rounded-lg items-center bg-[#080808]">
