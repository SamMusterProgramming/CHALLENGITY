  ...
  return (
    ...
    className="w-[100vw] max-h-[100%] flex-1 b g-white py- 1" >
        ...
        className="min-w-[100%] min-h-[100%] justify-start items-center" >
            ...
            <View 
            className=" w-[100%]  h- [200px] bg-[#000000] flex-col py-2 px- 2 justify-start items-center g-white ">
            <ScrollView 
              showsVerticalScrollIndicator ={false}
                ...
                className=" w- [100%] h- [100%] flex-col  py-2 gap-2  justify-center  items-center b g-[#1c1c1d] ">
                    {friendRequestReceived && friendRequestReceived.map((not , index)=> {
                        return(   
                            <View
                            key={index}
                            className="w-[100%] bg-[#1e2022] py-2 px-2 gap-2 flex-row justify-start items-end">
                                  <TouchableOpacity
                                  ...
                                  <Text
                                    ...
                                    className="text-gray-100 ml-auto mr-4 font-black text-base">
                                       {not.message}
                                  </Text>
           ...
           <View className="flex-row w-full bg-[#000000] px-2 py-0 mt- 1 gap-6  bor der-white bor der-b-4 justify-between items-end  h-[50px]">
            ...
            {showFollowings && (
                <View 
                className=" w-[100%] bg-[#000000] h- [200px] flex-col py-2 px- 2 justify-start items-center g-white ">
                    <ScrollView 
                    style={{ maxHeight : width /1.7 }}
                    className=" w-[100%] max-h- [200px] ">
                        <View 
            ...
            className="w-[100%] py-2 px-2 bg-[#000000] flex-row mb- 2 mt- 1 round ed-b-3xl  justify-center items-center">
                    ...
                    className="w-[100%] flex-row  justify-center  py-1 px-4  bg-gray-700 rounded-xl items-center">
                            <Text
                                ...
                                className="text-gray-100 font-black text-base">
                                    Log out
                           </Text>
                    </TouchableOpacity>
