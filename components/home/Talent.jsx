...
//           <View className="bg-[#f5f5fa] white w-[100%] flex-row justify-between items-center py-1 px-2 mb- 2 gap-2 ">
...
export default function Talent() {
    ...
    className="bg-black   w-[100%] flex-col px- 2 py-2 mt- 1 mb- 1 shadow-md round ed-xl">
          ...
          <View className="bg-[#f5f5fa] rounded-md white w-[100%] flex-row justify-between items-center py-1 px-2  gap-2 ">
                      ...
                      <TouchableOpacity
                      style ={{
                        backgroundColor : section !== 1 ? "black": "#072441"
                      }}
                      onPress={()=> {setSection(1)}}
                      className="justify-center rounded-lg min-w-[33%] items-center py-2 flex -1 w -[20%] px-1 h- [60] gap-1  bg-[#042b49] flex-col">
                                                  
                                                  <View
                                                   className="flex-row justify-start gap-2 items-end ">
                                                      <Text 
                                                        style={{fontSize:section == 1 ? 8 :7,
                                                        fontStyle:"italic"
                                                          }}
                                                          className="font-black  text-white">
                                                           User Talent
                                                  ...
                                                  <View
                                                    className="w- [30px] h- [30px] absolute top-1 right-1 rounded-full b g-white">
                                                        <MaterialCommunityIcons name="medal" size={15} color= "gold"  />
                                                  </View>
                      ...
                      <TouchableOpacity 
                      style ={{
                        backgroundColor : section !== 2 ? "black": "#072441"
                      }}
                       onPress={()=> {setSection(2)}}
                       className="justify-center rounded-lg w-[33%] items-center py-2 flex -1 w -[20%] px-1 h- [60] gap-1  bg-[#072441] flex-col">
                                                  <View
                                                   className="flex-row justify-start gap-2 items-end ">
                                                     
                                                      <Text 
                                                        style={{fontSize:section == 2 ? 8 :7,
                                                        fontStyle:"italic"
                                                          }}
                                                          className="font-black  text-white">
                                                              Explore
                      ...
                      <TouchableOpacity 
                      style ={{
                        backgroundColor : section !== 3 ? "black": "#072441"
                      }}
                       onPress={()=> {setSection(3)}}
                       className="justify-center rounded-lg w-[30%] items-center py-2 flex -1 w -[20%] px-1 h- [60] gap-1  bg-[#079de3] flex-col">
                                                  <View
